(() => {
  ...
  const PROJECTS = [
    ...
    { id:'ferrari-imoveis', name:'Ferrari Imóveis', tags:['Imóveis','Still','Vídeo'], folder:'ferrari-imoveis', count:15, video:'1219621575', videoRatio:'240/426' },
  ...
  const CLIENTS = [
    ...
    { name:'Ferrari Imóveis', cat:'Imobiliária', file:'mono/ferrari-imoveis.png', project:'ferrari-imoveis' },
